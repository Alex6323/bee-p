...
mod tests {
    ...
    struct SqlxBackendTest {}

    impl StorageTest for SqlxBackendTest {
        fn setup() -> () {
    ...
    #[test]
    fn test_all() {
        StorageTestRunner::run_test::<_, SqlxBackendTest>(|| {
            SqlxBackendTest::test_insert_one_transaction();
            SqlxBackendTest::test_insert_one_milestone();
            SqlxBackendTest::test_delete_one_transaction();
            SqlxBackendTest::test_delete_one_milestone();
            SqlxBackendTest::test_transaction_multiple_delete();
            SqlxBackendTest::test_map_hashes_to_approvers();
            SqlxBackendTest::test_map_missing_transaction_hashes_to_approvers();
            SqlxBackendTest::test_insert_transactions_concurrent();
            SqlxBackendTest::test_insert_transactions_batch();
        })
    }
}
