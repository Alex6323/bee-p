...
mod tests {
    ...
    fn validate_milestone_testnet_1537978_test() {
        ...
        generic_validate_milestone::<CurlP27>(MS_HASH, [MS_TX_0_TRYTES, MS_TX_1_TRYTES].to_vec(), 23, 1537978);
    }
    ...
    fn validate_milestone_testnet_1538144_test() {
        ...
        generic_validate_milestone::<CurlP27>(MS_HASH, [MS_TX_0_TRYTES, MS_TX_1_TRYTES].to_vec(), 23, 1538144);
    }
    ...
    fn validate_milestone_testnet_1538158_test() {
        ...
        generic_validate_milestone::<CurlP27>(MS_HASH, [MS_TX_0_TRYTES, MS_TX_1_TRYTES].to_vec(), 23, 1538158);
    }
}
