...
pub type MilestoneBuilder = StagedMilestoneBuilder<Kerl, Kerl, WotsPublicKey<Kerl>, IncomingRaw>;
...
mod tests {
    ...
    fn generic_validate_milestone(ms_hash: &str, ms_tx_array: Vec<&str>, depth: u8, index: MilestoneIndex) {
        let ms_hash_trits =
            Hash::try_from_inner(TryteBuf::try_from_str(ms_hash).unwrap().as_trits().encode::<T1B1Buf>()).unwrap();
        let mut builder = MilestoneBuilder::new(ms_hash_trits);
    ...
    #[test]
    fn validate_milestone_1368168_test() {
    ...
    // #[test]
    // fn validate_milestone_1367702_test() {
    ...
    // #[test]
    // fn validate_milestone_1363619_test() {
